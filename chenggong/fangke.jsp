...
<div id="zong">
	...
	<ul>
	<li style="margin-left:100px;"><a class="daohang" href="demo.jsp" target="_self">增加求租信息</a></li>
	<li style="margin-left:10px;"><a class="daohang" href="chakanqiuzu.do" target="_self">修改求租信息</a></li>
	<li style="margin-left:350px;"><a class="daohang" href="queryFang.do" target="_self"><b>查看房源信息</b></a></li>
	<li style="margin-left:15px;"><a class="daohang" href="shouye.jsp" target="_self"><b>退出登录</b></a></li>
