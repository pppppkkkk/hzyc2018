...
<div id="zong">
	...
	<ul>
	<li style="margin-left:100px;"><a class="daohang" href="zhuce.jsp" target="_self">注册</a></li>
	<li style="margin-left:10px;"><a class="daohang" href="denglu.jsp" target="_self">登录</a></li>
	<li style="margin-left:500px;"><a class="daohang" href="shouye.jsp" target="_self"><b>首页</b></a></li>
	<li style="margin-left:15px;"><a class="daohang" href="fenye.jsp" target="_self"><b>写字楼出租</b></a></li>
	<li style="margin-left:15px;"><a class="daohang" href="fenye.jsp" target="_self"><b>商铺出租</b></a></li>
	<li style="margin-left:10px;"><a class="daohang" href="http://mall.haozu.com/index.php?city=bj" target="_self"><b>好租商城</b></a></li>
	<li style="margin-left:10px;"><a class="daohang" href="http://www.haozu.com/bj/zx/" target="_self"><b>咨询中心</b></a></li>
	</ul>
	</div>
	
	
	<div style="margin-top:260px;position:relative;top:-360px;left:300px;">
		<form action="SelectFangByXiaoqu.do">
	  	<input type="text" name="xiaoqu" placeholder="输入你想搜索的区域" style="width:600px;height:45px;font-size:20px;"/>
	  	<input type="submit" value="开始找房" style="width:105px;height:50px;margin-left:-8px;font-size:20px;background-color:orange;color:white;font-weight:bold;border:0px;"/>
	  	</form>
	...
	<div id="zhuanti">
		...
		<img class="tu" src="image/4.jpg" id ="4" style="margin-left:70px;" onmouseover="big1()" onmouseout="small1()"/>
		...
		<img class="tu" src="image/7.jpg" id ="7" style="margin-top:20px;margin-left:20px;"  onmouseover="big4()" onmouseout="small4()"><br><br>
